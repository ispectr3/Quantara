...
import ogImage from "../assets/og-quantara.jpg";
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Quantara",
          description: "Wealth Intelligence: carteiras consolidadas das principais casas de private banking.",
          slogan: "Wealth Intelligence",
        }),
      },
    ],
  }),
